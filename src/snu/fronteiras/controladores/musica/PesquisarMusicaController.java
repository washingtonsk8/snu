...
public class PesquisarMusicaController implements Initializable {
    ...
    private void pesquisarPorParametros() {
        ...
        parametrosPesquisa.setTag(this.fldTags.getText());
